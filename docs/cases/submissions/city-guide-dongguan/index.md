...
> 请在此处补充成品截图（建议 2-5 张：首屏、千年脉络、湾区区位、城市气质、大学资源）。

```md
![WorkBuddy 执行效果——首屏](./assets/01-首屏.png)
![WorkBuddy 执行效果——千年脉络](./assets/02-千年脉络.png)
![WorkBuddy 执行效果——湾区区位](./assets/03-湾区区位.png)
![WorkBuddy 执行效果——城市气质](./assets/04-城市气质.png)
![WorkBuddy 执行效果——大学资源](./assets/05-大学资源.png)
```
